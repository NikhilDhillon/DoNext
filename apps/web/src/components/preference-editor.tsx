    ...
    <main className="page-shell narrow-page">
      ...
      <form className="preference-form" onSubmit={savePreferences}>
        ...
        <section className="preference-section">
          ...
          <label><span>Freeze window</span><select name="freeze_window_hours" defaultValue={value.freeze_window_minutes / 60}><option value="0">No freeze window</option><option value="1">1 hour</option><option value="2">2 hours</option><option value="4">4 hours</option><option value="6">6 hours</option><option value="12">12 hours</option><option value="24">24 hours</option></select></label>
          <p className="preference-help">DoNext retains a one-hour rollover buffer each day. Only overdue work or work due within 48 hours may use it automatically.</p>
        </section>
